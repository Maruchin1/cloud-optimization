...
def generate_instances(w_t, w_e, num_of_instances):
    instances_arr = []
...
def run_experiment(name, w_t, w_e, num_of_instances):
    print('-- Starting experiment:', name)
    instances_arr = generate_instances(w_t, w_e, num_of_instances)
...
if __name__ == '__main__':
    run_experiment('weights_0,3-0,7', 0.3, 0.7, 10)
